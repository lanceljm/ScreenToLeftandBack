...
#import "YXBaseNacigationController.h"

@interface YXBaseNacigationController ()<UIGestureRecognizerDelegate>

@property ( strong , nonatomic ) NSMutableArray * blackList ;

@end

@implementation YXBaseNacigationController
